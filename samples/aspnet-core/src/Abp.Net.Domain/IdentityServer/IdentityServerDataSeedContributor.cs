...
namespace Abp.Net.IdentityServer;
...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("Net", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateClientAsync(
                ...
                secret: (configurationSection["Net_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
        ...
        {
            var webClientRootUrl = configurationSection["Net_App:RootUrl"]?.TrimEnd('/');
            ...
            await CreateClientAsync(
                ...
                secret: (configurationSection["Net_App:ClientSecret"] ?? "1q2w3e*").Sha256(),
        ...
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateClientAsync(
                ...
                secret: configurationSection["Net_Swagger:ClientSecret"]?.Sha256(),
                requireClientSecret: false,
