...
namespace Abp.Net.Web
{
    ...
    [Controller]
    [ControllerName("LoginA")]
    [Area("accountA")]
    [Route("api/accountA")]
    public class MyAccountController : AbpControllerBase//Volo.Abp.Account.Web.Areas.Account.Controllers.AccountController
    {
        ...
        public MyAccountController(
            ...
            IOptions<IdentityOptions> identityOptions)// : base(signInManager, userManager, settingProvider, identitySecurityLogManager, identityOptions)
        {
